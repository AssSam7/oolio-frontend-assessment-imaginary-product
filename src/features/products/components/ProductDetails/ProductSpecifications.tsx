import type { ProductSpecifications as ProductSpecificationsType } from "@/domain/products/types/productDetails.types";
    ...
    <div className="bg-card border border-border rounded-lg p-4 md:p-6">
      ...
      <div className="space-y-3">
        {Object.entries(specifications).map(([key, value]) => (
          ...
          >
            <span className="text-sm md:text-base font-medium text-muted-foreground min-w-[160px]">
              {key}
            </span>
